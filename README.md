...
- [ ] What problem does the context API help solve?
	...
	solves the problem of having to prop drill large applications and gives the ability to share data across the entire application

- [ ] In your own words, describe `actions`, `reducers` and the `store` and their role in Redux. What does each piece do? Why is the store known as a 'single source of truth' in a redux application?
	
	actions are the source of data for your store - they use payloads to send data into your store
	reducers handle your state and regulates changes to your state.
	the store holds your entire state for the application

	single source of truth - in regards to the redux store - is referring to it being the one place where your state is held and the only place it can be changed.

- [ ] What is the difference between Application state and Component state? When would be a good time to use one over the other?

	component state is stored locally within the component and not available to other components - useful for handlers etc
	application state is maintained in the store and is available globally

- [ ] Describe `redux-thunk`, what does it allow us to do? How does it change our `action-creators`?
	
	redux thunk is middleware that gives you the ability to use action creators that return another function instead of returning an object

- [ ] What is your favorite state management system you've learned and this sprint? Please explain why!

	Redux store is my favorite as it seems the most intuitive. 
