    ...
    return (
        <div className='add-smurf' >
            <form className='add-form' onSubmit={addSmurf} >
                <input placeholder='Name' type='text' name='name' value={name} onChange={updateName} />
                <input placeholder='Age' type='text' age='age' value={age} onChange={updateAge} />
                <input placeholder='Height' type='text' name='name' value={height} onChange={updateHeight} />
